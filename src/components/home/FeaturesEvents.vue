      ...
      <v-col cols="12" md="12" lg="12" sm="12" class="mb-0">
        <p class="google-font mb-0 mt-0" style="font-weight: 350;font-size:180%">
          <b>
            ...
            <span style="color: #2AFF00;">Negocios</span>
            &
            <span style="color: #2AFF00;">Inteligencia Artificial</span>
          </b>
        </p>
        <p
          class="google-font mt-0 mb-0"
          style="font-size:95%"
        > la IA es capaz de aprender de sus experiencias, encontrar correlaciones, crear hipótesis,</p> 
          
          <p> los resultados y aprender de ellos, lo que sería algo realmente útil para los
           negocios en la era digital.</p>
      </v-col>
